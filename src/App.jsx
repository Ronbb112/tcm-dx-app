...
const FORMULAS = [
  ...
  { id:"f3", name:"Bai Hu Tang", nameHe:"באי הו טאנג", element:"fire", tree:"Shi Gao", pattern:"Yang Ming Qi-level Heat", indications:"4 הגדולים: חום גבוה, צמא, הזעה, דופק מהיר. משך: 1-3 שבועות", heatCold:"heat" },
  ...
  { id:"f5", name:"Xue Fu Zhu Yu Tang", nameHe:"שואה פו ז'ו יו טאנג", element:"fire", tree:"Chai Hu", pattern:"Blood Stasis in Chest", indications:"כאבי ראש כרוניים, כאב חזה", heatCold:"neutral" },
  { id:"f6", name:"Tian Wang Bu Xin Dan", nameHe:"טיאן וואנג בו שין דאן", element:"fire", tree:"Ren Shen", pattern:"Heart & Kidney Yin Xu", indications:"חרדה, הזעות לילה", heatCold:"heat" },
  ...
  { id:"f14", name:"Li Zhong Wan", nameHe:"לי ג'ונג וואן", element:"earth", tree:"Gan Jiang", pattern:"Internal Cold", indications:"קולות מים בבטן, מזון לא מעוכל בצואה", heatCold:"cold" },
  { id:"f15", name:"Bu Zhong Yi Qi Tang", nameHe:"בו ג'ונג יי צ'י טאנג", element:"earth", tree:"Huang Qi", pattern:"SP Qi Sinking", indications:"צניחה, טחורים, עייפות כרונית", heatCold:"cold" },
  ...
  { id:"f23c", name:"Xuan Fu Dai Zhi Shi Tang", nameHe:"שואן פו דאי ז'י שי טאנג", element:"earth", tree:"Ban Xia", pattern:"Rebellious ST Qi", indications:"שיהוקים, גיהוקים", heatCold:"neutral" },
  ...
  { id:"f32", name:"Si Wu Tang", nameHe:"סי וו טאנג", element:"wood", tree:"Gui Zhi", pattern:"LV Blood Xu", indications:"עור יבש, ראייה מטושטשת, ציפורניים דקות", heatCold:"cold" },
  ...
  { id:"f34", name:"Bu Gan Tang", nameHe:"בו גאן טאנג", element:"wood", tree:"Gui Zhi", pattern:"LV Blood & Yin Xu", indications:"התכווצויות שרירים, עיניים יבשות", heatCold:"cold" },
  ...
  { id:"f37", name:"Yin Chen Hao Tang", nameHe:"יין צ'ן האו טאנג", element:"wood", tree:"Da Huang", pattern:"Damp-Heat / LV Infections", indications:"צהבת, סקלרה צהובה", heatCold:"heat" },
  ...
  { id:"f37d", name:"Wu Mei Wan", nameHe:"וו מיי וואן", element:"wood", tree:"Gui Zhi", pattern:"Jue Yin — Extreme Yin-Yang Imbalance", indications:"חום למעלה קור למטה, צמא חזק, רעב ללא רצון לאכול", heatCold:"neutral" },
  { id:"f37e", name:"Dang Gui Si Ni Tang", nameHe:"דאנג גווי סי ני טאנג", element:"wood", tree:"Gui Zhi", pattern:"Jue Yin Meridian Cold", indications:"אצבעות קפואות, דופק דק", heatCold:"cold" },
  // METAL
  ...
  { id:"f45b", name:"Ma Huang Tang", nameHe:"מא הואנג טאנג", element:"metal", tree:"Ma Huang", pattern:"Tai Yang Wind-Cold (no sweat)", indications:"צפצופים ללא הזעה", heatCold:"cold" },
  ...
  { id:"f49", name:"You Gui Wan", nameHe:"יאו גווי וואן", element:"water", tree:"Fu Zi", pattern:"Strong KD Yang Xu", indications:"אימפוטנציה, תשישות", heatCold:"cold" },
  ...
  { id:"f54", name:"Shao Fu Zhu Yu Tang", nameHe:"שאו פו ז'ו יו טאנג", element:"water", tree:"Gan Jiang", pattern:"Lower Abdomen Blood Stasis", indications:"כאבי מחזור", heatCold:"neutral" },
  ...
  { id:"f54g", name:"Bai Tou Weng Tang", nameHe:"באי טואו ונג טאנג", element:"water", tree:"Huang Lian", pattern:"Toxic Heat / Dysentery", indications:"דיזנטריה זיהומית, שלשול רעיל", heatCold:"heat" },
  // YANG MING PURGING
