...
const FORMULAS = [
  ...
  { id:"f5", name:"Xue Fu Zhu Yu Tang", nameHe:"שואה פו ז'ו יו טאנג", element:"fire", tree:"Da Huang", pattern:"Blood Stasis in Chest", indications:"כאבי ראש כרוניים, כאב חזה", heatCold:"neutral" },
  ...
  { id:"f37d", name:"Wu Mei Wan", nameHe:"וו מיי וואן", element:"wood", tree:"Gan Jiang", pattern:"Jue Yin — Extreme Yin-Yang Imbalance", indications:"חום למעלה קור למטה, צמא חזק, רעב ללא רצון לאכול", heatCold:"neutral" },
  ...
  { id:"f54", name:"Shao Fu Zhu Yu Tang", nameHe:"שאו פו ז'ו יו טאנג", element:"water", tree:"Gui Zhi", pattern:"Lower Abdomen Blood Stasis", indications:"כאבי מחזור", heatCold:"neutral" },
